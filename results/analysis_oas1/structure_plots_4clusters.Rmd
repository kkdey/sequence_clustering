...
barplot(t(nosmooth_pi_ordered), col = c(2, 5:3), axisnames = F, space = 0, border = NA, main = "structure plot for unsmoothed model", las = 1, ylim = c(0, 1), cex.axis = 1.5, cex.main = 1.4)
